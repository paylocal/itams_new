  ...
  return (
    <aside key={locale} className="w-64 bg-white border-r min-h-screen flex flex-col">
      <div className="p-6 border-b">
        <h1 className="text-xl font-bold text-blue-600">{t("common.appName", "Quản lý yêu cầu và tài sản")}</h1>
      </div>
      ...
      <div className="p-4 border-t text-xs text-gray-500">Quản lý yêu cầu và tài sản v1.0.0</div>
    </aside>
  );
}
