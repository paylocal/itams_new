    ...
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-bold">
          {locale === "vi" ? "Biên bản Bàn giao" : "Handovers"}
        </h1>
        <p className="text-gray-500 mt-1">
          {handovers.length} {locale === "vi" ? "bàn giao" : "handovers"}
        </p>
      </div>
      ...
      {handovers.length === 0 ? (
        <div className="bg-white p-12 rounded-lg shadow text-center text-gray-500">
          ...
          <p>{locale === "vi" ? "Chưa có bàn giao nào" : "No handovers yet"}</p>
        </div>
      ) : (
            ...
            return (
              ...
              >
                ...
                <div className="text-sm text-gray-600 space-y-1 mt-3">
                  <p>📦 {h.items.length} {locale === "vi" ? "thiết bị" : "items"}</p>
